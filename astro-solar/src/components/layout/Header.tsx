            ...
            {user ? (
              <div className="relative">
                <button
                  ...
                  className="w-8 h-8 rounded-full bg-gradient-to-br from-blue-500 to-green-500 flex items-center justify-center text-white font-semibold text-sm overflow-hidden ring-2 ring-white"
                >
          ...
          {user ? (
            <div className="relative">
              ...
              >
                ...
                <div className="w-9 h-9 rounded-full bg-gradient-to-br from-blue-500 to-green-500 flex items-center justify-center text-white font-semibold text-sm ring-2 ring-gray-200">
                  {getInitials(user.name)}
                </div>
              </button>
            ...
            <a
              href="/login"
              className="flex items-center gap-2 pl-4 border-l border-gray-200 text-sm text-blue-600 hover:text-blue-700 font-medium"
            >
              Đăng nhập
            </a>
          )}
