  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 flex items-center justify-between gap-4">
        ...
        <nav className="hidden md:flex items-center gap-1 bg-white/60 backdrop-blur-2xl rounded-full px-3 py-2 shadow-[0_8px_32px_rgba(0,0,0,0.08)] border border-white/40 relative overflow-hidden">
